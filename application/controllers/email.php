    ...
    public function index()
    {
      // Konfigurasi email
        $config = [
            ...
            'smtp_user' => 'brownMITg@gmail.com',  // Email gmail
            'smtp_pass'   => 'cumajombloyangbolehmasuk',  // Password gmail
            'smtp_crypto' => 'ssl',
            'smtp_port'   => 465,
            'crlf'    => "\r\n",
            'newline' => "\r\n"
        ...
        $this->email->from('brownMITg@gmail.com', 'MasRud.com');

        // Email penerima
        $this->email->to('alfiandannyarmanta@gmail.com'); // Ganti dengan email tujuan
